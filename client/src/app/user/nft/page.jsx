...
import AdquireNft from "@/components/common/AdquireNft";
            ...
            <tbody>
              {projectsInfo && projectsInfo.length === 3 && projectsInfo.map((project, index) => (
                <tr
                  ...
                  className={`border-b  border-gray-100 last:border-0 ${index % 2 === 0 ? "bg-var(--theme-surface-background)" : "glass-effect-dark"
                    }`}
                >
                  {/* Colibri / Proyecto */}
